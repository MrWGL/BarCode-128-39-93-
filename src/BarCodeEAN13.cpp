...
{
	m_EAN13_Code = new vector<element13*>();
	m_EAN13_Code->push_back(new element13("0", "", "0001101", "0100111", "1110010"));
	m_EAN13_Code->push_back(new element13("1", "AAAAAA", "0011001", "0110011", "1100110"));
	m_EAN13_Code->push_back(new element13("2", "AABABB", "0010011", "0011011", "1101100"));
	m_EAN13_Code->push_back(new element13("3", "AABBAB", "0111101", "0100001", "1000010"));
	m_EAN13_Code->push_back(new element13("4", "ABAABB", "0100011", "0011101", "1011100"));
	m_EAN13_Code->push_back(new element13("5", "ABBAAB", "0110001", "0111001", "1001110"));
	m_EAN13_Code->push_back(new element13("6", "ABBBAA", "0101111", "0000101", "1010000"));
	m_EAN13_Code->push_back(new element13("7", "ABABAB", "0111011", "0010001", "1000100"));
	m_EAN13_Code->push_back(new element13("8", "ABABBA", "0110111", "0001001", "1001000"));
	m_EAN13_Code->push_back(new element13("9", "ABBABA", "0001011", "0010111", "1110100"));
}
